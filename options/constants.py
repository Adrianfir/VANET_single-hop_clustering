...
class Inputs:
    def __init__(self):
        ...
        trace_path = str(pathlib.Path(__file__).parent.parent.absolute().
                         joinpath('final_data_Richmondhill_largesize', 'sumoTrace_no_bus_and_rsu.xml'))
        sumo_edge_path = str(pathlib.Path(__file__).parent.parent.absolute().
                             joinpath('final_data_Richmondhill_largesize', 'osm.net.xml'))
        sumo_node_path = str(pathlib.Path(__file__).parent.parent.absolute().
                             joinpath('final_data_Richmondhill_largesize', 'osm_bbox.osm.xml'))
        ...
        fps = 5
        weights = np.array([0.5, 0.5, 0.5])      # direction's angle, speed, distance
